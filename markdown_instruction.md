...
**git checkout 1234** - переход к версии с хэшем, начинающимся на 1234

**git checkout master** - переход к текущему состоянию (если основная ветка master не переименована)

**git diff** - показывает разницу между последним изменением и текущим состоянием
